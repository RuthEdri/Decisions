...
const PUZZLES = [
  {
    ...
    title: "🔐 הצופן הכפול",
    type: "text",
    scenario: `על הדלת נמצאת הוראה מוצפנת:\n\n📜 כלל הצופן:\n• כל אות שווה למספרה באלפבית (א=1, ב=2, ג=3 ... ת=22)\n• כל אות מוכפלת במיקומה במילה\n• חבר את כל התוצאות\n\n🔑 המילה הסודית: ב - ח - ר`,
    question: "מה הסכום הסופי לפי כלל הצופן?",
    hint: "💡 חשב כל אות בנפרד: ערך האות × מיקומה, ואז חבר את שלוש התוצאות.",
    answer: "78",
  ...
  },
  {
    ...
    title: "🧠 שעון ההחלטות",
    type: "text",
    scenario: `בחדר נמצאים שלושה לוחמים: יוסי, אבי וציון.\nכל אחד מהם מתכנן כמה זמן לחשוב לפני שיקבל החלטה חשובה.\n\nהנה מה שידוע:\n• ציון מתכנן לחשוב חצי מהזמן שאבי מתכנן\n• יוסי מתכנן לחשוב פי 4 מציון\n• יחד הם מתכננים לחשוב 42 דקות`,
    question: "כמה דקות מתכנן יוסי לחשוב?",
    hint: "💡 סמן את זמן ציון כ-X. אז אבי = 2X, יוסי = 4X. חבר ומצא את X.",
    answer: "24",
